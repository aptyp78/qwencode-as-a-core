...
def connect_extended_quotes_to_graph():
    ...
    # Загружаем граф
    graph_path = "/Users/arturoceretnyj/fradkov-ontology/output/fradkov_ontology_enriched.json"
    ...
    output_path = "/Users/arturoceretnyj/fradkov-ontology/output/fradkov_ontology_final.json"
...
• output/fradkov_ontology_final.json — финальный граф
• output/fradkov_ontology_vectorized.json — векторизованный граф
• output/fradkov_graph_visualization.html — визуализация
• data/fradkov_quotes_extended.json — база высказываний (525 цитат)
...
if __name__ == "__main__":
    ...
    # Сохраняем описание
    summary_path = "/Users/arturoceretnyj/fradkov-ontology/output/FINAL_SUMMARY.md"
