...
def merge_all_real_quotes():
    ...
    sources = [
        "/Users/arturoceretnyj/fradkov-ontology/data/fradkov_massive_parsed_quotes.json",
        "/Users/arturoceretnyj/fradkov-ontology/data/fradkov_real_quotes_final.json",
        "/Users/arturoceretnyj/fradkov-ontology/data/fradkov_quotes.json"
    ]
    ...
    output_path = "/Users/arturoceretnyj/fradkov-ontology/data/fradkov_all_real_quotes.json"
...
def add_quotes_to_graph(quotes_db: dict):
    ...
    graph_path = "/Users/arturoceretnyj/fradkov-ontology/output/fradkov_ontology_clean.json"
    ...
    output_path = "/Users/arturoceretnyj/fradkov-ontology/output/fradkov_ontology_final_real.json"
    with open(output_path, "w", encoding="utf-8") as f:
