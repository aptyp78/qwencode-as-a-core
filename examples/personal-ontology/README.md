# Personal Ontology — персональное векторно-графовое пространство

Первый экземпляр онтологического пространства в среде **QwenCode-as-a-Core**.
Инструмент стохастического сопоставления новых документов с известным контекстом деятельности субъекта.
