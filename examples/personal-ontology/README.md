...
**Субъект текущего экземпляра:** настраивается в `config/subject.yaml`
...
- **Quote** — цитата/утверждение субъекта
- **OpenEvent** — событие из открытых источников (выступление, интервью, встреча)
- **System** — система/контекст (домены деятельности)
- **Circumstance** — обстоятельства (где, при каких условиях)
- **TimelineEvent** — верифицированные факты карьеры
...
3. Локальный LLM → извлечение утверждений субъекта
