...
def load_vector_graph_space():
    ...
    with open("/Users/arturoceretnyj/personal-ontology/output/fradkov_vector_graph_space.json", "r", encoding="utf-8") as f:
        return json.load(f)
...
if __name__ == "__main__":
    ...
    # Визуализируем
    output_path = "/Users/arturoceretnyj/personal-ontology/output/fradkov_vector_space_visualization.html"
