...
def extract_entities_and_relations():
    ...
    # Загружаем данные
    with open("/Users/arturoceretnyj/personal-ontology/data/fradkov_biography.json", "r", encoding="utf-8") as f:
        bio_data = json.load(f)
    
    with open("/Users/arturoceretnyj/personal-ontology/data/fradkov_additional_sources.json", "r", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    # Сохраняем
    output_path = "/Users/arturoceretnyj/personal-ontology/output/personal_ontology_graph.json"
