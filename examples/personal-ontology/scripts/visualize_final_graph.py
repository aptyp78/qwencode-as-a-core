...
def load_final_graph():
    ...
    with open("/Users/arturoceretnyj/personal-ontology/output/personal_ontology_final.json", "r", encoding="utf-8") as f:
        return json.load(f)
...
if __name__ == "__main__":
    ...
    output_path = "/Users/arturoceretnyj/personal-ontology/output/fradkov_graph_final_visualization.html"
